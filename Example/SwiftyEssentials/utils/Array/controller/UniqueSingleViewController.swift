//
//  UniqueSingleExampleViewController.swift
//  SwiftyUtils_Example
//
...
class UniqueSingleViewController: UIViewController {
...
extension UniqueSingleViewController: UITableViewDataSource {
    ...
    func tableView(_ tableView: UITableView, cellForRowAt indexPath: IndexPath) -> UITableViewCell {
        ...
        case 0:
            ...
            case 2:
                ...
                cell.codeLabel.text = "mutating func unique()"
                return cell
            default: return UITableViewCell()
            }
        case 1:
            let cell = tableView.dequeueReusableCell(withIdentifier: "example_cell") as! UniqueSingleExampleTableViewCell
            return cell
        default: return UITableViewCell()
        }
    }
