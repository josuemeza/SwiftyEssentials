//
//  HasOnlyOneElementSingleViewController.swift
//  SwiftyUtils_Example
//
...
class HasOnlyOneElementSingleViewController: UIViewController {
...
extension HasOnlyOneElementSingleViewController: UITableViewDataSource {
    ...
    func tableView(_ tableView: UITableView, cellForRowAt indexPath: IndexPath) -> UITableViewCell {
        ...
        case 0:
            ...
            case 0:
                ...
                cell.titleLabel.text = "Has only one element"
                return cell
            case 1:
            ...
            case 2:
                ...
                cell.codeLabel.text = "var hasOnlyOneElement: Bool"
                return cell
            default: return UITableViewCell()
            }
        case 1:
            let cell = tableView.dequeueReusableCell(withIdentifier: "example_cell") as! HasOnlyOneElementSingleExampleTableViewCell
            return cell
        default: return UITableViewCell()
        }
    }
